...
"""
Usage:
    python run_model.py --input "[0.03, 0.05, 0.06, 0.02, -0.04, -0.04, -0.04, -0.00, 0.01, -0.03]"
"""
...
def main():
    ...
    parser.add_argument("--input", required=True,
                        help="Feature list as JSON string (10 features). Example: \"[0.03,0.05,0.06,0.02,-0.04,-0.04,-0.04,-0.00,0.01,-0.03]\"")
